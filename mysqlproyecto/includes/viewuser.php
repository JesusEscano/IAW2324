            ...
            <tbody>
                <tr>
                    ...
                    if (isset($_GET['incidencia_id'])) {
                        ...
                        $query="SELECT incidencias.*, plantas.planta, aulas.aula FROM incidencias INNER JOIN plantas ON incidencias.planta_id = plantas.id INNER JOIN aulas ON incidencias.aula_id = aulas.id WHERE incidencias.id = $incidenciaid LIMIT 1";  
