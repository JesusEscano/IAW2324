...
<div class="container">
    <?php
    $id_id = $_SESSION["id"];
    $totalc = "SELECT COUNT(*) as total FROM incidencias WHERE usuario_id = '$id_id'";
    $resueltasc = "SELECT COUNT(*) as resueltas FROM incidencias WHERE fecha_sol IS NOT NULL AND fecha_sol <> '0000-00-00' AND usuario_id = '$id_id'";
    $pendientesc = "SELECT COUNT(*) as pendientes FROM incidencias WHERE fecha_sol IS NULL AND usuario_id = '$id_id'";
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <a class="navbar-brand"><img src="../IESlogo.jpg" width="30" height="30" class="d-inline-block align-top" alt="Logo Machado"> INCIDENCIAS RESUELTAS (<?php echo $resueltas; ?>)</a>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <?php
                    $query = "SELECT incidencias.*, plantas.planta, aulas.aula FROM incidencias INNER JOIN plantas ON incidencias.planta_id = plantas.id INNER JOIN aulas ON incidencias.aula_id = aulas.id WHERE incidencias.fecha_sol IS NOT NULL AND fecha_sol <> '0000-00-00' AND usuario_id = '$id_id' ORDER BY incidencias.id ASC";               
