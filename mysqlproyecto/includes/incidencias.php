...
<?php include "login.php"?>
  ...
  <?php
        $totalc = "SELECT COUNT(*) as total FROM incidencias WHERE usuario_id = $usuario_id";
        $resueltasc = "SELECT COUNT(*) as resueltas FROM incidencias WHERE fecha_sol IS NOT NULL AND fecha_sol <> '0000-00-00' AND usuario_id = $usuario_id";
        $pendientesc = "SELECT COUNT(*) as pendientes FROM incidencias WHERE fecha_sol IS NULL AND usuario_id = $usuario_id";
