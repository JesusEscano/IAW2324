  ...
  <?php
    ...
    <a href="../logout.php"><i class="bi bi-box-arrow-left"></i> Desconectar</a>
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <?php
            $query="SELECT * FROM incidencias WHERE fecha_sol IS NOT NULL AND fecha_sol <> '0000-00-00' AND usuario_id = (SELECT id FROM usuarios WHERE id = '$id_id') ORDER BY id ASC";               
