    ...
    <div class="container">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <?php
                    $query = "SELECT incidencias.*, plantas.planta, aulas.aula FROM incidencias INNER JOIN plantas ON incidencias.planta_id = plantas.id INNER JOIN aulas ON incidencias.aula_id = aulas.id WHERE incidencias.fecha_sol IS NULL AND usuario_id = '$id_id' ORDER BY incidencias.id ASC";               
